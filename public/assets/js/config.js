/**
* Theme: Karivio - Responsive Tailwind CSS 3 Admin Dashboard
* Author: Karivio Team
...
(function () {
    ...
    var savedConfig = sessionStorage.getItem("__KARIVIO_CONFIG__");
    // var savedConfig = localStorage.getItem("__KARIVIO_CONFIG__");
