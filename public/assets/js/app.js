/**
* Theme: Karivio - Responsive Tailwind Admin Dashboard
* Author: Karivio Team
* Module/App: App js
*/
...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        ...
        sessionStorage.setItem('__KARIVIO_CONFIG__', JSON.stringify(this.config));
        // localStorage.setItem('__KARIVIO_CONFIG__', JSON.stringify(this.config));
