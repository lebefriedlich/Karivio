                    ...
                    <form wire:submit.prevent="save" class="space-y-12">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-6">
                                ...
                                <h5 class="text-xl font-bold text-slate-900 dark:text-slate-200">{{ __('Data Pribadi') }}</h5>
                            </div>
                            <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Nama Lengkap') }}</label>
                                <input type="text" wire:model.live="full_name" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('Nama Lengkap') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Nomor Telepon') }}</label>
                                <input type="tel" wire:model="phone" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('0812...') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Email') }}</label>
                                <input type="email" wire:model="email" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('email@contoh.com') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Kota Asal') }}</label>
                                <input type="text" wire:model="city" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('Kota') }}">
                            </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Nama Perusahaan') }}</label>
                                <input type="text" wire:model.live="company_name" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('Nama Perusahaan') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Posisi yang Dilamar') }}</label>
                                <input type="text" wire:model.live="applied_position" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('Posisi') }}">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Alamat Perusahaan') }}</label>
                                <input type="text" wire:model="company_address" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="{{ __('Alamat Perusahaan') }}">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1 text-slate-700 dark:text-slate-300">{{ __('Tanggal Surat') }}</label>
                                <input type="date" wire:model="date" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500">
                            </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-6">
                                ...
                                <h5 class="text-xl font-bold text-slate-900 dark:text-slate-200">{{ __('Isi Surat (Body)') }}</h5>
                            </div>
                            <textarea wire:model="content" rows="15" class="w-full px-3 py-2 border border-gray-300 text-black dark:border-slate-700 dark:bg-slate-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 font-mono text-sm"></textarea>
                        </div>
            ...
            <div class="sticky top-6 space-y-6">
                <div class="bg-indigo-600 rounded-2xl p-6 text-white shadow-xl" style="border-radius: 2rem !important;">
                    <h5 class="font-black flex items-center gap-2 mb-4 uppercase tracking-wider">
                        <i class="ri-lightbulb-line"></i> {{ __('Panduan Placeholder') }}
                    </h5>
                    <div class="space-y-4">
                        <p class="text-sm opacity-90 leading-relaxed">{{ __('Gunakan kode di bawah ini di dalam teks surat Anda agar data terisi otomatis:') }}</p>
